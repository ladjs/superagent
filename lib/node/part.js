...
Part.prototype.attachment = function(name, filename, dispositiontype){
  if (!dispositiontype) dispositiontype = 'attachment';
  this.type(filename);
  this.set('Content-Disposition', dispositiontype + '; name="' + name + '"; filename="' + basename(filename) + '"');
  return this;
};
