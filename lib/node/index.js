...
Request.prototype.send = function(data){
  ...
  if ('GET' == this.method || 'DELETE' == this.method) return this;
  if (!obj) return this;
...
Request.prototype.request = function(){
  ...
  // querystring
  if (('GET' == this.method || 'DELETE' == this.method) && null != data) {
...
Request.prototype.end = function(fn){
  ...
  // body
  if ('GET' == this.method || 'HEAD' == this.method || 'DELETE' == this.method) {
    data = null;
