 ...
 * with optional `filename` and `dispositiontype`. 
 * `dispositiontype` defaults to `attachment`
 *
 * @param {String} field
 * @param {String} file
...
Request.prototype.attach = function(field, file, filename, dispositiontype){
  if (!dispositiontype) { 
    dispositiontype = 'attachment';
  }
  debug('attach %s %s for type', field, file,dispositiontype);
...
Request.prototype.writeAttachments = function(){
  ...
  this.attachmentSize(function(total){
    function next() {
      ...
      file.part.attachment(file.field, file.filename, file.dispositiontype);
